...
{
    guiState.onButtonPlace = Rect(20, display.rows - 60, 70, 40);
	guiState.offButtonPlace = Rect(180, display.rows - 60, 70, 40);
	guiState.saveButtonPlace = Rect(100, display.rows - 60, 70, 40);
